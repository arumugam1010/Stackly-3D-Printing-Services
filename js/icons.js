/* SVG-in-JS Icon Registry */

const ICON_REGISTRY = {
  printer: `<img src="assets/images/logo_transparent.webp" alt="Stackly 3D Logo" style="width: 100%; height: 100%; object-fit: contain; display: block; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.15));">`,
  ...
  'bar-chart': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>`,
  ...
  log: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>`,
...
function initializeIcons() {
  ...
  elements.forEach(element => {
    ...
    if (ICON_REGISTRY[iconName]) {
      element.innerHTML = ICON_REGISTRY[iconName];
      
      // Transfer styles or classes if needed, but standard SVG takes values from parent stroke/fill color
      const svg = element.querySelector('svg');
      if (svg) {
        // Carry any custom styling/size classes if specified
        if (element.classList.contains('icon-sm')) {
          svg.setAttribute('width', '16');
          svg.setAttribute('height', '16');
        } else if (element.classList.contains('icon-lg')) {
          svg.setAttribute('width', '32');
          svg.setAttribute('height', '32');
        } else if (element.classList.contains('icon-xl')) {
...
// Make global so other dynamic modules can call it
